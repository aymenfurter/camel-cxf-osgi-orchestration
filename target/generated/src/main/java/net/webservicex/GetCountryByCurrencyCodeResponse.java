...
@XmlRootElement(name = "GetCountryByCurrencyCodeResponse", namespace = "http://www.webserviceX.NET")
public class GetCountryByCurrencyCodeResponse {

    @XmlElement(name = "GetCountryByCurrencyCodeResult", namespace = "http://www.webserviceX.NET")
