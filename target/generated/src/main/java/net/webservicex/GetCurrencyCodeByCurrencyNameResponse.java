...
@XmlRootElement(name = "GetCurrencyCodeByCurrencyNameResponse", namespace = "http://www.webserviceX.NET")
public class GetCurrencyCodeByCurrencyNameResponse {

    @XmlElement(name = "GetCurrencyCodeByCurrencyNameResult", namespace = "http://www.webserviceX.NET")
