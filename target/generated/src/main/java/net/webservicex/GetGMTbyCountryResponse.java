...
@XmlRootElement(name = "GetGMTbyCountryResponse", namespace = "http://www.webserviceX.NET")
public class GetGMTbyCountryResponse {

    @XmlElement(name = "GetGMTbyCountryResult", namespace = "http://www.webserviceX.NET")
