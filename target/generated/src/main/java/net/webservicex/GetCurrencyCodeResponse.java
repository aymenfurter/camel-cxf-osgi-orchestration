...
@XmlRootElement(name = "GetCurrencyCodeResponse", namespace = "http://www.webserviceX.NET")
public class GetCurrencyCodeResponse {

    @XmlElement(name = "GetCurrencyCodeResult", namespace = "http://www.webserviceX.NET")
